...
public class IndexWriter implements Closeable, TwoPhaseCommit {
     ...
     *             be initialized.
     * @throws CorruptIndexException     if the index is corrupt
     * @throws LockObtainFailedException if another writer has this index open (<code>write.lock</code>
     ...
     *
     * @lucene.experimental <p><b>NOTE</b>: warm is called before any deletes have
